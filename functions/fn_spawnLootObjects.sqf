...
for "_i" from floor (random (count (_allBuildingPos) / 4)) to (count (_allBuildingPos) / 4) do {
	...
	if ((_building getVariable "lCount") <= (ceil (count (_allBuildingPos) / 4))) then {
		...
		_lootObject setPosATL _buildingPOS;
		...
		switch (_EdenSubCat) do {
			case "City": { 
				...
				switch true do {
					case (_rnd < 50) : { _lootObject setVariable ["lType", "empty"] };
					case (_rnd >= 50 && _rnd < 70) : { _lootObject setVariable ["lType", "food"] };
					case (_rnd >= 70 && _rnd < 80) : { _lootObject setVariable ["lType", "medical"] };
			...
			case "Military": { 
				...
				switch true do {
					...
					case (_rnd >= 50 && _rnd < 75) : { _lootObject setVariable ["lType", "medical"] };
					case (_rnd >= 75 && _rnd < 85) : { _lootObject setVariable ["lType", "weapons_pistol"] };
					case (_rnd >= 85 && _rnd < 97) : { _lootObject setVariable ["lType", "weapons_rifle"] };
					case (_rnd >= 97) : { _lootObject setVariable ["lType", "weapons_launcher"] };
			...
			case "Shop": { 
				...
				_rnd = floor (random 100);
				switch true do {
					case (_rnd < 45) : { _lootObject setVariable ["lType", "empty"] };
					case (_rnd >= 45 && _rnd < 75) : { _lootObject setVariable ["lType", "food"] };
					case (_rnd >= 75 && _rnd < 90) : { _lootObject setVariable ["lType", "medical"] };
			...
			case "Religious": { 
				...
				switch true do {
					case (_rnd < 60) : { _lootObject setVariable ["lType", "empty"] };
					case (_rnd >= 60 && _rnd < 75) : { _lootObject setVariable ["lType", "food"] };
					case (_rnd >= 75 && _rnd < 95) : { _lootObject setVariable ["lType", "medical"] };
			...
			case "Industrial": { 
				...
				_rnd = floor (random 100);
				switch true do {
					case (_rnd < 70) : { _lootObject setVariable ["lType", "empty"] };
					case (_rnd >= 70 && _rnd < 80) : { _lootObject setVariable ["lType", "food"] };
					case (_rnd >= 80 && _rnd < 90) : { _lootObject setVariable ["lType", "medical"] };
					case (_rnd >= 90 && _rnd < 97) : { _lootObject setVariable ["lType", "weapons_pistol"] };
					case (_rnd >= 97) : { _lootObject setVariable ["lType", "weapons_rifle"] };
					// case  : { _lootObject setVariable ["lType", "weapons_launcher"] };
			...
			case "Utilities": { 
				...
				switch true do {
					case (_rnd < 50) : { _lootObject setVariable ["lType", "empty"] };
					case (_rnd >= 50 && _rnd < 60) : { _lootObject setVariable ["lType", "food"] };
					case (_rnd >= 60 && _rnd < 80) : { _lootObject setVariable ["lType", "medical"] };
					case (_rnd >= 80 && _rnd < 95) : { _lootObject setVariable ["lType", "weapons_pistol"] };
					case (_rnd >= 95) : { _lootObject setVariable ["lType", "weapons_rifle"] };
					// case  : { _lootObject setVariable ["lType", "weapons_launcher"] };
			...
			case "Airport": { 
				...
				switch true do {
					case (_rnd < 50) : { _lootObject setVariable ["lType", "empty"] };
					case (_rnd >= 50 && _rnd < 65) : { _lootObject setVariable ["lType", "food"] };
					case (_rnd >= 65 && _rnd < 75) : { _lootObject setVariable ["lType", "medical"] };
