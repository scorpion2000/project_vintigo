...
_weaponHolderLimit = 48+((count allPlayers)*2);	// Weapon Holders. Set -1 to disable.
_weaponHolderDistCheck = TRUE;					// TRUE to delete any weapon holders that are far from players.
_weaponHolderDist = 200;						// Distance (meters) from players that ground garbage is not deleted if below max.
